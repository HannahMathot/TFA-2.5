...
function toLessives() {
    smallTitle.innerHTML = "Combien de lessives faites-vous par mois ?";
...
function toVitres() {
    smallTitle.innerHTML = "Combien de fois par an lavez-vous vos fenêtres ?";
...
function toWC() {
    smallTitle.innerHTML = "Combien de fois par mois nettoyez-vous vos wc ?";
...
function toTablettes() {
    smallTitle.innerHTML = "Combien de lave-vaisselle faites-vous par semaine ?";
...
function toMulti() {
    smallTitle.innerHTML = "Combien de fois par mois lavez-vous vos meubles avec votre produit multi-usage ?";
...
function toDegraissant() {
    smallTitle.innerHTML = "Combien de fois par mois avez-vous besoin de votre dégraissant ?";
...
function toDesodorisant() {
    smallTitle.innerHTML = "Combien de fois par mois désodorisez-vous les pièces de votre maison ?";
...
function toDetartrant() {
    smallTitle.innerHTML = "Combien de fois par an détartrez-vous vos canalisations ?";
...
function toLiquide() {
    smallTitle.innerHTML = "Combien de fois par mois lavez-vous vos plats avec du liquide vaisselle ?";
...
function addNumber() {
    ...
    localStorage.setItem('compteur-final-number', currentNumberNumber);
    currentNumber.innerHTML = localStorage.getItem('compteur-final-number');
    if (smallTitle.textContent == "Combien de lessives faites-vous par mois ?") {
        localStorage.setItem('lessive-number', currentNumberNumber);
    } else if (smallTitle.textContent == "Combien de lave-vaisselle faites-vous par semaine ?") {
        localStorage.setItem('tablettes-number', currentNumberNumber);
    } else if (smallTitle.textContent == "Combien de fois par mois désodorisez-vous les pièces de votre maison ?") {
        localStorage.setItem('desodorisant-number', currentNumberNumber);
    }
}
...
function slideRange() {
    ...
    localStorage.setItem('slider-range-normal-final-value', this.value);
    if (smallTitle.textContent == "Combien de fois par an lavez-vous vos fenêtres ?") {
        localStorage.setItem('vitres-number', this.value);
    } else if (smallTitle.textContent == "Combien de fois par mois lavez-vous vos meubles avec votre produit multi-usage ?") {
        localStorage.setItem('multi-number', this.value);
    } else if (smallTitle.textContent == "Combien de fois par an détartrez-vous vos canalisations ?") {
        localStorage.setItem('detartrant-number', this.value);
    }
...
$("#round").roundSlider({
    ...
    drag: function (e) {
        ...
        if (smallTitle.textContent == "Combien de fois par mois nettoyez-vous vos wc ?") {
            localStorage.setItem('wc-number', e.value);
        } else if (smallTitle.textContent == "Combien de fois par mois avez-vous besoin de votre dégraissant ?") {
            localStorage.setItem('degraissant-number', e.value);
        } else if (smallTitle.textContent == "Combien de fois par mois lavez-vous vos plats avec du liquide vaisselle ?") {
